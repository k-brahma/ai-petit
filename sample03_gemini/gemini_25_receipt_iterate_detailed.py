...
def normalize_results(results):
    ...
    for result in results:
        ...
        normalized_result['総支払額'] = normalize_amount(result['総支払額'])
        normalized_result['消費税額'] = normalize_amount(result['消費税額'])
...
def main():
    ...
    if results:
        ...
        save_results(normalized_results, "results")
